(function () {
    ...
    ylm('harm-y60', 'Harmonic Y(6,0)', function (t, p) { var c = C(t); return 231 * Math.pow(c, 6) - 315 * Math.pow(c, 4) + 105 * c * c - 5; }, 0x9b5de5, 52);

    ylm('harm-y66', 'Harmonic Y(6,6)', function (t, p) { return Math.pow(S(t), 6) * C(6 * p); }, 0xff8f3f, 50);
})();
