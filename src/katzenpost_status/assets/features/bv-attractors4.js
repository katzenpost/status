(function () {
    ...
    attractor('rayleighbenard', 'Rayleigh-Benard attractor', function (p, dt) { var a = 9, r = 12, b = 5, x = p[0], y = p[1], z = p[2]; return [x + dt * (-a * x + a * y), y + dt * (r * x - y - x * z), z + dt * (x * y - b * z)]; }, [0.1, 0, 0], 0.01, 5000, 1.4, [0, 0, 12], 0xff8f3f, 62);
})();
