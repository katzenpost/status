(function () {
    ...
    cv('lk-3-5-7', 'Lissajous knot 3:5:7', lk(3, 5, 7, 0, 0.7, 0.2), 0x9b5de5, 58, 1200);

    cv('lk-2-5-9', 'Lissajous knot 2:5:9', lk(2, 5, 9, 0.5, 0, 0.9), 0xff5d8f, 58, 1200);

    cv('lk-4-5-7', 'Lissajous knot 4:5:7', lk(4, 5, 7, 0.6, 0.2, 0), 0xff8f3f, 58, 1200);

    cv('lk-3-4-5', 'Lissajous knot 3:4:5', lk(3, 4, 5, 0, 0.9, 0.4), 0x00d2a0, 58, 1200);

    cv('lk-3-7-8', 'Lissajous knot 3:7:8', lk(3, 7, 8, 0.2, 0, 0.7), 0xffd23f, 58, 1200);

    cv('lk-2-7-9', 'Lissajous knot 2:7:9', lk(2, 7, 9, 0.5, 0.3, 0), 0xff5d6c, 58, 1200);

    cv('lk-4-7-9', 'Lissajous knot 4:7:9', lk(4, 7, 9, 1.1, 0.3, 0.2), 0x33ccff, 58, 1200);

    cv('lk-5-6-7', 'Lissajous knot 5:6:7', lk(5, 6, 7, 0.4, 0.9, 0.1), 0x8a5bff, 58, 1200);
})();
