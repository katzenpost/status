(function () {
    ...
    cloud('barnsleyifs', 'Barnsley IFS (tree)', function (T) { var x = 0, y = 0, pts = [], i; for (i = 0; i < 6000; i++) { var r = Math.random(), nx, ny; if (r < 0.1) { nx = 0; ny = 0.35 * y; } else if (r < 0.7) { nx = 0.42 * x - 0.42 * y; ny = 0.42 * x + 0.42 * y + 0.4; } else if (r < 0.85) { nx = 0.42 * x + 0.42 * y; ny = -0.42 * x + 0.42 * y + 0.4; } else { nx = 0.1 * x; ny = 0.1 * y + 0.05; } x = nx; y = ny; if (i > 40 && i % 3 === 0 && pts.length < 500) pts.push(new T.Vector3(x * 22, y * 22 - 12, (Math.random() - 0.5) * 1.5)); } return pts; }, 2, 0x00d2a0, 58);
})();
