(function () {
    ...
    cv('rou-11-7', 'Toroidal roulette 11:7', rou(10, 4, 11, 4, 7), 0xff5d6c, 58, 1600);

    cv('rou-5-13', 'Toroidal roulette 5:13', rou(9, 6, 5, 5, 13), 0x33ccff, 58, 1600);

    cv('rou-7-8', 'Toroidal roulette 7:8', rou(12, 5, 7, 3, 8), 0x8a5bff, 58, 1600);
})();
