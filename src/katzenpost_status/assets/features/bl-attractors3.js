(function () {
    ...
    attractor('lu', 'Lu (Chen family) attractor', function (p, dt) { var a = 36, b = 3, c = 20, x = p[0], y = p[1], z = p[2]; return [x + dt * a * (y - x), y + dt * (-x * z + c * y), z + dt * (x * y - b * z)]; }, [0.1, 0.2, 0.3], 0.004, 5000, 0.62, [0, 0, 20], 0xff8f3f, 66);
})();
