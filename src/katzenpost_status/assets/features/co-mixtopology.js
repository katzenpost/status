...
mk('mix-strata','Stratified mix DAG',0x2ec4b6,62,undefined,function(d,T){return pipe(d,T,{});});mk('mix-cascade','Cascade columns',0x4d8bf0,62,undefined,function(d,T){return pipe(d,T,{edge:'matched'});});
})();
