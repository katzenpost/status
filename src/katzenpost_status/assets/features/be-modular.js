(function () {
    ...
    ae('cantorset', 'Cantor set', function (a, e, T, color) { var ints = [[0, 1]], lvl; for (lvl = 0; lvl <= 6; lvl++) { ints.forEach(function (iv) { var x0 = (iv[0] - 0.5) * 42, x1 = (iv[1] - 0.5) * 42, y = 18 - lvl * 5; var p0 = new T.Vector3(x0, y, 0), p1 = new T.Vector3(x1, y, 0); a.push(p0); a.push(p1); e.push({ a: p0, b: p1, color: color }); }); var nxt = []; ints.forEach(function (iv) { var t = (iv[1] - iv[0]) / 3; nxt.push([iv[0], iv[0] + t]); nxt.push([iv[1] - t, iv[1]]); }); ints = nxt; } }, 0xff5d8f, 56);
})();
